...
public class Api {
    ...
    public static LaGonetteService.Partner partner() {
        if (SERVICE_PARTNER == null) throw new IllegalStateException("SERVICE_PARTNER was not set!");
    ...
    public static LaGonetteService.Category category() {
        if (SERVICE_CATEGORY == null) throw new IllegalStateException("SERVICE_CATEGORY was not set!");
