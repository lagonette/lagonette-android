package org.lagonette.app.tools.showcase;
...
public class RoundRectangleShape implements Shape {
	...
	public RoundRectangleShape(int width, int height, int xRadius, int yRadius) {
		this.width = width;
		this.height = height;
	...
	public RoundRectangleShape(Rect bounds, int xRadius, int yRadius) {
