...
public class TailLocator<VH extends RecyclerView.ViewHolder> implements AdapterLocator<VH> {

    @Override
    public boolean handlePosition(int position, @NonNull AdapterComponent<VH> component, @NonNull AdapterLink<VH> nextLink) {
        return position >= nextLink.getItemCount();
    }

    @Override
    public int calculateInsertedBeforeCount(int position, @NonNull AdapterComponent<VH> component, @NonNull AdapterLink<VH> nextLink) {
    ...
    @Override
    public int getItemCount(int nextLinkItemCount, @NonNull AdapterComponent<VH> component, @NonNull AdapterLink<VH> nextLink) {
