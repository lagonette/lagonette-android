        ...
        return new SqlBuilder().build()
                .startGroup()
                    ...
                    .join(Tables.CATEGORY, MAIN_CATEGORY)
                        .on(Tables.PARTNER, PartnerColumns.MAIN_CATEGORY, MAIN_CATEGORY, CategoryColumns.ID)
                    ...
                    .leftJoin(Tables.CATEGORY, SIDE_CATEGORY)
                        .on(Tables.PARTNER_SIDE_CATEGORIES, PartnerSideCategoriesColumns.CATEGORY_ID, SIDE_CATEGORY, CategoryColumns.ID)
