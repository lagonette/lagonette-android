    ...
    public static String getFilterStatement() {
        return new SqlBuilder().build()
                ...
                .leftJoin(Tables.PARTNER, MAIN_PARTNER)
                    .on(Tables.CATEGORY, CategoryColumns.ID, MAIN_PARTNER, PartnerColumns.MAIN_CATEGORY)
                ...
                .leftJoin(Tables.PARTNER, SIDE_PARTNER)
                    .on(Tables.PARTNER_SIDE_CATEGORIES, PartnerSideCategoriesColumns.PARTNER_ID, SIDE_PARTNER, PartnerColumns.ID)
                ...
                .where()
                    ...
                    .and()
                    .statement(LaGonetteContract.CategoryMetadata.IS_COLLAPSED).equals(0)
