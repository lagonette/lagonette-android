package org.lagonette.android.app.widget.behavior;
...
public class ParallaxBehavior<V extends View>
    ...
    public ParallaxBehavior(Context context, AttributeSet attrs) {
        ...
        TypedValue value = a.peekValue(R.styleable.LaGonetteBehavior_dependency);
        if (value != null) {
            mDependencyId = a.getResourceId(
                    R.styleable.LaGonetteBehavior_dependency, 0);
        }
        a.recycle();
    }
